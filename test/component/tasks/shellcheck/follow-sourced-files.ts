...
suite('ShellCheck Follow Sourced Files Configuration', () => {
    let taskLibGetInputStub: Sinon.SinonStub;
    let taskLibGetBoolInputStub: Sinon.SinonStub;
    let getFollowSourcedFilesInputStub: Sinon.SinonStub;
    ...
    setup(() => {
        ...
        getFollowSourcedFilesInputStub = utils.shellCheckTask.stubs.getTaskLibGetFollowSourcedFilesInputStub(taskLibGetBoolInputStub);
    ...
    test('Should correctly handle scan failure', async () => {
        getFollowSourcedFilesInputStub.callsFake(() => true);
    ...
    test('Should correctly handle scan success', async () => {
        getFollowSourcedFilesInputStub.callsFake(() => false);
