...
suite('Tasks', () => {
    const organization = process.env.AZURE_DEVOPS_TASK_VALIDATION_ORGANIZATION || 'swellaby-azp-task-validation';
    const project = process.env.AZURE_DEVOPS_TASK_VALIDATION_PROJECT || 'OpenSource';
